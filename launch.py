...
def prepare_environment():
    ...
    comfy_repo = os.environ.get('COMFY_REPO', "https://github.com/ZHO-ZHO-ZHO/ComfyUI-ZHO-Chinese")
    comfy_commit_hash = os.environ.get('COMFY_COMMIT_HASH', "2c97c30256a00e71e93f11130012a5da0b726c17")
